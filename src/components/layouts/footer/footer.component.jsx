                    ...
                    <div className="col-xs-12 col-sm-6 col-md-3">
                        ...
                        <div className="module-body">
                            <ul className="toggle-footer" >
                                <li className="media">
                                    <div className="pull-left"><span className="icon fa-stack fa-lg"> <i
                                        className="fa fa-map-marker fa-stack-1x fa-inverse"></i> </span></div>
                                ...
                                <li className="media">
                                    <div className="pull-left"><span className="icon fa-stack fa-lg"> <i
                                        className="fa fa-mobile fa-stack-1x fa-inverse"></i> </span></div>
                                    <div className="media-body">
                                        <p>+(888) 123-4567<br/>
                                            +(888) 456-7890</p>
                                    </div>
                                ...
                                <li className="media">
                                    <div className="pull-left"><span className="icon fa-stack fa-lg"> <i
                                        className="fa fa-envelope fa-stack-1x fa-inverse"></i> </span></div>
                                    <div className="media-body"><span><a href="#">flipmart@themesground.com</a></span>
                                    </div>
                                </li>
                            </ul>
                        </div>
        ...
        <div className="copyright-bar">
            <div className="container">
                <div className="col-xs-12 col-sm-6 no-padding social">
                    <ul className="link">
                        <li className="fb pull-left"><a target="_blank" rel="nofollow" href="#" title="Facebook"></a>
                        </li>
                        <li className="tw pull-left"><a target="_blank" rel="nofollow" href="#" title="Twitter"></a>
                        </li>
                ...
                <div className="col-xs-12 col-sm-6 no-padding">
                    <div className="clearfix payment-methods">
                        <ul>
                            <li><img src="%PUBLIC_URL%/assets/images/payments/1.png" alt="" /></li>
                            <li><img src="%PUBLIC_URL%/assets/images/payments/2.png" alt="" /></li>
                            <li><img src="%PUBLIC_URL%/assets/images/payments/3.png" alt="" /></li>
                            <li><img src="%PUBLIC_URL%/assets/images/payments/4.png" alt="" /></li>
                            <li><img src="%PUBLIC_URL%/assets/images/payments/5.png" alt="" /></li>
                        </ul>
                    </div>
